...
class Product_services extends ClientsController
{
    ...
    {
        if (!has_contact_permission('items') || !has_permission('peralatan', '', 'view')) {
    ...
    {
        if (!has_contact_permission('items') || !has_permission('peralatan', '', 'create')) {
            set_alert('warning', _l('access_denied'));
            redirect(site_url());
        }
            ...
            if ($id == '') {
               if (!has_contact_permission('items') || !has_permission('peralatan', '', 'create')) {
                ...
                if ($id) {
                    ...
                    redirect(site_url('peralatan/product_services/'));
                }
            } else {
                if (!has_contact_permission('items') || !has_permission('peralatan', '', 'edit')) {
                    set_alert('warning', _l('access_denied'));
                    redirect(site_url());
                }
    ...
    {
        if (!has_contact_permission('items') || !has_permission('peralatan', '', 'delete')) {
            set_alert('warning', _l('access_denied'));
            redirect(site_url());
        }
        if (!$id) {
