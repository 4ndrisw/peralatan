...
$aColumns = hooks()->apply_filters('peralatan_table_sql_columns', $aColumns);
...
foreach ($rResult as $aRow) {
    ...
    $row[] = '<a href="' . admin_url('peralatan/list_peralatan/' . $aRow[db_prefix() . 'peralatan.id']) . '" onclick="init_peralatan(' . $aRow[db_prefix() . 'peralatan.id'] . '); return false;">' . $aRow['subject'] . '</a>';
