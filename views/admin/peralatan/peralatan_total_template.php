...
<div class="row">
<?php if(count($peralatan_years) > 1 || isset($currencies)){ ?>
  <div class="col-md-12 simple-bootstrap-select mbot5">
   <?php if(isset($currencies)){ ?>
    <select class="selectpicker" data-width="auto" name="total_currency" onchange="init_peralatan_total();">
    ...
    <?php } ?>
      <?php
      if(count($peralatan_years) > 1){ ?>
      <select data-none-selected-text="<?php echo date('Y'); ?>" data-width="auto" class="selectpicker" multiple name="peralatan_total_years" onchange="init_peralatan_total();">
         <?php foreach($peralatan_years as $year){ ?>
