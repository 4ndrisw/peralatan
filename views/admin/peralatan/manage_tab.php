               ...
               <div class="panel-body _buttons">
                  ...
                  <div class="display-block text-right">
                      ...
                      <div class="display-block pull-left mleft5">
                          <a href="#" class="btn btn-default equipments-total" onclick="slideToggle('#stats-top'); init_peralatan_total(true); return false;" data-toggle="tooltip" title="<?php echo _l('view_stats_tooltip'); ?>"><i class="fa fa-bar-chart"></i></a>
                      </div>
