...
<div class="modal fade peralatan-convert-modal" id="convert_to_invoice" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-xxl" role="document">
        <?php echo form_open('admin/peralatan/convert_to_invoice/'.$peralatan->id,array('id'=>'peralatan_convert_to_invoice_form','class'=>'_transaction_form invoice-form')); ?>
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">
                    <span class="edit-title"><?php echo _l('peralatan_convert_to_invoice'); ?></span>
                </h4>
            </div>
...
<script>
    ...
    init_color_pickers();
    init_items_sortable();
    validate_invoice_form('#peralatan_convert_to_invoice_form');
    <?php if($peralatan->assigned != 0){ ?>
     $('#convert_to_invoice #sale_agent').selectpicker('val',<?php echo $peralatan->assigned; ?>);
    <?php } ?>
